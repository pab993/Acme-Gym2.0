...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			...
			<li><a class="fNiv" href="workout/search.do"><spring:message code="master.page.workout.search" /></a></li>
		...
		<security:authorize access="hasRole('MANAGER')">
			<li><a class="fNiv" href="workout/searchLogin.do"><spring:message code="master.page.workout.search" /></a></li>
			<li><a class="fNiv" href="activity/list.do"><spring:message code="master.page.activity.list" /></a></li>
			<li><a class="fNiv" href="gym/list.do"><spring:message code="master.page.gym.list" /></a></li>
